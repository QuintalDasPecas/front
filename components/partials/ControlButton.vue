<template>
    <div class="row g-2 justify-content-md-center box-button">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-grid gap-2 d-md-flex justify-content-md-start">
            <NuxtLink @click="redirectTo( redirectUrl )" class="btn btn-primary btn-lg btn-width-defult">
                <i class="pi pi-arrow-left"></i> Voltar
            </NuxtLink>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-grid gap-2 d-md-flex justify-content-md-end">
